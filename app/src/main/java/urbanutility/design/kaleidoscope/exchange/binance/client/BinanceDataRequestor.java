...
public class BinanceDataRequestor implements DataRequestor {
    ...
    private Function<List<BinancePriceTicker>, List<KaleidoLiveMarket>> binanceLiveMarketMapper() {
        return new Function<List<BinancePriceTicker>, List<KaleidoLiveMarket>>() {
            @Override
            public List<KaleidoLiveMarket> apply(List<BinancePriceTicker> binancePriceTickers) throws Exception {
                List<KaleidoLiveMarket> kaleidoLiveMarkets = new ArrayList<>();
                for (BinancePriceTicker ticker : binancePriceTickers) {
                    KaleidoLiveMarket kaleidoLiveMarket = new KaleidoLiveMarket(
                            ticker.getSymbol(),
                            "binance",
                            Double.parseDouble(ticker.getPrice()));
                    kaleidoLiveMarkets.add(kaleidoLiveMarket);
                }
